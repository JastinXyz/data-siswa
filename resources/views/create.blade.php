...
<body>
    <div class="py-10 px-16">
        <h1 class="text-3xl font-bold">Input Data Siswa</h1>
        <form action="/siswa/create" method="POST" class="space-y-4">
            @csrf
            <div class="form-control">
                <label class="label">
                    <span class="label-text text-lg">NIS <span class="text-red-500 required-dot">*</span></span>
                </label>
                <input name="nis" type="number" placeholder="xxxxxx" class="input input-bordered" required/>
            </div>
            <div class="form-control">
                <label class="label">
                    <span class="label-text text-lg">Nama <span class="text-red-500 required-dot">*</span></span>
                </label>
                <input name="nama" type="text" placeholder="Budi" class="input input-bordered" required/>
            </div>
            <div class="form-control">
                <label class="label">
                    <span class="label-text text-lg">Tempat, Tanggal Lahir <span class="text-red-500 required-dot">*</span></span>
                </label>
                <input name="ttl" type="text" placeholder="Banyumas, 32 Desember 2000" class="input input-bordered" required/>
            </div>
            <div class="form-control">
                <label class="label">
                    <span class="label-text text-lg">Kelas <span class="text-red-500 required-dot">*</span></span>
                </label>
                <input name="kelas" type="text" placeholder="XI RPL" class="input input-bordered" required/>
            </div>
            <div class="mt-6">
